...
Partial Class FrmArrivals
    ...
    Private Sub InitializeComponent()
        ...
        'RoomTransCollection
        '
        Me.RoomTransCollection.ObjectType = GetType(WaiterModel.Cmp300.RoomTrans)
        '
        'GridView1
        '
        ...
        'colArrivalDate
        '
        Me.colArrivalDate.Caption = "Ημερ/νία Άφηξης"
        ...
        'colDueDate
        '
        Me.colDueDate.Caption = "Ημερ/νία Αναχώρησης"

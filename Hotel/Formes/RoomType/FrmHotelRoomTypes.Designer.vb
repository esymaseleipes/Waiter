...
Partial Class FrmHotelRoomTypes
    ...
    Private Sub InitializeComponent()
        ...
        Me.MainBedCmb.Columns.AddRange(New DevExpress.XtraEditors.Controls.LookUpColumnInfo() {New DevExpress.XtraEditors.Controls.LookUpColumnInfo("Oid", "Oid", 39, DevExpress.Utils.FormatType.Numeric, "", False, DevExpress.Utils.HorzAlignment.Far), New DevExpress.XtraEditors.Controls.LookUpColumnInfo("Descr", "Περιγραφή Κρεβατιού", 37, DevExpress.Utils.FormatType.None, "", True, DevExpress.Utils.HorzAlignment.Near), New DevExpress.XtraEditors.Controls.LookUpColumnInfo("Persons", "Άτομα", 48, DevExpress.Utils.FormatType.Numeric, "", True, DevExpress.Utils.HorzAlignment.Far)})
        ...
        'BedsCollection
        '
        Me.BedsCollection.ObjectType = GetType(WindowsApplication1.Cmp300.BedType)
        '
        'GridColumn2
        '
